...
const NavigationBar = () => {
  ...
  return (
    <ul className="bg-light border-b-2 fixed -translate-x-4 md:-translate-x-8 -translate-y-20 md:-translate-y-24 font-semibold text-md sm:text-lg w-full px-4 md:px-8 py-3 md:py-4 whitespace-nowrap z-10 *:inline">
