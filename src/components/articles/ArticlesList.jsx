...
const ArticlesList = () => {
  const { currentArticles, selectedCategory } = useArticles()
  ...
  return (
    <section { ...currentArticles.length && {
      ...
      }}>
      {
        ...
        : <>
            <h2 className="font-semibold text-lg sm:text-xl">Coming soon!</h2>
            <p>No {selectedCategory.toLowerCase()} here yet.</p>
          </>
      }
    </section>
  )
